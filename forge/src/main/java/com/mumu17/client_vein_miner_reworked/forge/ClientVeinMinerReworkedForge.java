package com.mumu17.client_vein_miner_reworked.forge;
...
public final class ClientVeinMinerReworkedForge {
    public ClientVeinMinerReworkedForge() {
        ...
        DistExecutor.runWhenOn(Dist.CLIENT, () -> () -> {
            ClientVeinMinerReworkedForge.registerScreen();
